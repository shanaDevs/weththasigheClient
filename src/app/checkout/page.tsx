    ...
    try {
      ...
      if (paymentMethod === 'payhere' && (order as any).payhereData) {
        ...
        payhere.onCompleted = function onCompleted() {
          ...
          router.push(`/orders/${order.orderNumber}?payment=success`);
        };
        ...
        payhere.onError = function onError(error: any) {
          ...
          router.push(`/orders/${order.orderNumber}?payment=failed`);
        };

        // Enable sandbox mode if configured
        payhere.sandbox = !!(order as any).payhereData.sandbox;
        payhere.startPayment((order as any).payhereData);
      } else {
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className={Number(cart.shippingAmount) === 0 ? "text-emerald-600 font-medium" : "text-slate-900 font-medium"}>
